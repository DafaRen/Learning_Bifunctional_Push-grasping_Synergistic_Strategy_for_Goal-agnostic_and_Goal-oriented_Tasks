...
class Robot(object):
    ...
    def add_objects(self):
        ...
        for object_idx in range(len(self.obj_mesh_ind)):
            ...
            drop_x = (self.workspace_limits[0][1] - self.workspace_limits[0][0] - 0.2) * np.random.random_sample() * 1.2 + self.workspace_limits[0][0] + 0.1
            drop_y = (self.workspace_limits[1][1] - self.workspace_limits[1][0] - 0.2) * np.random.random_sample() * 1.2 + self.workspace_limits[1][0] + 0.1
